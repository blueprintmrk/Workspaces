...
function WebTrends() {
	var that = this;
	if (typeof(gDcsId) != "undefined" && gDcsId)
		this.dcsid = gDcsId;
	else
		this.dcsid = "not_a_valid_dcsid";
	if (typeof(gDomain) != "undefined" && gDomain)
		this.domain = gDomain;
	else
		this.domain = "m.webtrends.com";
	if (typeof(gTimeZone) != "undefined" && gTimeZone)
	...
	if (typeof(gOffsite) != "undefined" && gOffsite)
		if (gOffsite == true || gOffsite == "true")
			this.fpcdom = "";
	this.navigationtag = "div,table";
	if (typeof(gTrackEvents) != "undefined" && gTrackEvents && (gTrackEvents == 1 || gTrackEvents == "1"))
		this.trackevents = true;
	else
		this.trackevents = false;
	this.evi = {
		cookie : "MC1, A",
		qp : "WT.dcsvid, WT.z_Acookie",
		crumb : "",
		sep : ""
	};
	this.enabled = true;
...
WebTrends.prototype.dcsMSVar = function () {
	...
	if (this.dcsGetCookie("MC1") != null)
		this.WT.dcsvid = this.dcsGetCrumb(this.dcsGetCookie("MC1"), "GUID", "&");
...
WebTrends.prototype.dcsMSImageMap = function (evt) {
	...
	if (evt && (typeof evt.which != "number" || evt.which == 1)) {
		...
		if (e.href && e.protocol && e.protocol.indexOf("http") != -1 && !this.dcsMSLinkTrackException(e)) {
			if ((e.onclick) || (e.onmousedown)) {
				this.dcsMSSetVarCap(e);
			}
			...
			if (e.attributes.getNamedItem("cid"))
				this.DCSext.wt_linkid = e.attributes.getNamedItem("cid").value;
...
WebTrends.prototype.dcsMSNvr = function () {
	...
	var cfields = {
		name : "WT_NVR",
		value : "",
		expiry : "; expires=" + exp.toGMTString(),
		path : "; path=/",
